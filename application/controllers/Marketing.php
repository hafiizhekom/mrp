...
class Marketing extends CI_Controller {
	...
	public function joborder($param=null){
		if($param=="add"){
			...
			$this->db->select('a.*,c.name as customer_name,b.qn_number,d.name as project_name,b.order_type,DATE_ADD(b.delivery_date, INTERVAL b.quotation_valid DAY) as due_date,e.name as marketing');
