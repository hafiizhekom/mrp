<html lang="en"><head>
    ...
    <title>MRP Bill of Quantity List
</title>
...
<?php $this->load->view('engineering/header'); ?>
    ...
    <div class="container-fluid" style="min-height: 76.6vh;">
        <div class="header">
            <h5 style="font-weight: bold;">Bill Of Quantity</h5>
        </div>
        <div class="body">
          <div class="col-md-3 col-md-offset-9" style="text-align:right;">
              <a href="<?php echo base_url() ?>engineering/boq/create"><button class="btn btn-success"><i class="fa fa-plus"></i> Add New Bill of Quantity</button></a>
          </div>
          <div class="col-md-12">
...
<form method="POST" id="form_edit" action="<?php echo base_url() ?>Engineering/boq/create">
  <input type="hidden" id="edit_input" name="id" />
</form>
<form method="POST" id="form_remove" action="<?php echo base_url() ?>Engineering/boq/remove">
  <input type="hidden" id="remove_input" name="id" />
</form>
<div class="modal fade" id="status_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?php echo base_url() ?>Engineering/boq/status_update" method="POST">
