    ...
    <div class="container-fluid" style="min-height: 76.6vh;">
        ...
        <div class="body">
            <div class="col-md-3 col-md-offset-9" style="text-align:right;">
                <a href="<?php echo base_url() ?>engineering/master/create"><button class="btn btn-success"><i class="fa fa-plus"></i> Add New Master Part</button></a>
            </div>
            <div class="col-md-12">
...
<form id="edit_form" action="<?php echo base_url() ?>engineering/master/create" method="POST">
    <input type="hidden" id="edit" name="id" />
</form>

<form id="delete_form" action="<?php echo base_url() ?>engineering/master/delete" method="POST">
