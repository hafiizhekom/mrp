<html lang="en"><head>
    ...
    <title>MRP     Monitoring Progress Job Order
</title>
...
<?php $this->load->view('ppic/header'); ?>
    <div class="container-fluid" style="min-height: 77.5vh">
        <div class="header">
            <h5 style="font-weight: bold"> Monitoring Progress Job Order</h5>
        </div>
        <div class="body">
            <div class="row">
                <div class="col-md-12">
                    <form action="<?php echo base_url() ?>ppc/schedule/monitoring" method="post" class="form form horizontal">
                        <input type="hidden" name="_token" value="DUNUYFjaB3lw8PFFQPCDISLePcom4LHcPi9KLbtx">
                        <div class="wrapper">
                            <div class="box">
                                <div class="box-header">
                                    <h5>Monitoring Progress Job Order</h5>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="label-control col-md-3">Year</label>
                                                <div class="col-md-9">
                                                  <select name="year" class="form-control input-size-auto"> 
                                                    <option value="2020">2020</option>
                                                    <option value="2021">2021</option>
                                                  </select></div>
                                            </div>
                                            <div class="form-group">
                                                <label class="label-control col-md-3">Method</label>
                                                <div class="col-md-9">
                                                    <input id="radio-print" type="radio" checked="" name="action" value="print">
                                                    <label for="radio-print">Print</label>
                                                    <input id="radio-download" type="radio" name="action" value="download">
                                                    <label for="radio-download">Download</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
