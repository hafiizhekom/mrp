...
<?php $this->load->view('logistic/header'); ?>
    ...
    <div class="container-fluid" style="min-height: 77.5vh">
        ...
        <div class="body">
            <div class="col-md-12">
                <!--v-start--><form method="POST" class="form form-horizontal" action="<?php echo base_url() ?>logistic/consumable/add">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control input-sm" name="minimal">
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <tbody>
              <?php $i=1; foreach ($table as $key => $value) {?>
                  <tr>
                      ...
                      <td><?php echo $value->minimal_stock; ?></td>
                      <td><?php echo $value->unit; ?></td>
                      <td><?php echo $value->size; ?></td>
                      <td><center><button class="btn btn-info edit_button" data="<?php echo $value->id; ?>" code="<?php echo $value->code; ?>" qualification="<?php echo $value->qualification ?>" data-name="<?php echo $value->name; ?>" minimal_stock="<?php echo $value->minimal_stock;
                       ?>" unit="<?php echo $value->unit; ?>" size="<?php echo $value->size; ?>"><i class="fa fa-edit"></i> Edit</button><button class="btn btn-danger remove_button" data="<?php echo $value->id; ?>"><i class="fa fa-trash"></i> Delete</button></center></td>
                  </tr>
              <?php $i+=1; } ?>
          </tbody>
      </table>
...
$(document).ready(function(){
  ...
  $(document).on("click",".edit_button",function(){
    ...
    $("input[name='qualification']").val($(this).attr("qualification"));
    $("input[name='minimal']").val($(this).attr("minimal_stock"));
