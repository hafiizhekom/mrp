...
<?php $this->load->view('admin/header'); ?>
    <div class="container-fluid" style="min-height: 77.5vh">
        ...
        <div class="body">
            <div class="col-md-6">
                <form method="post" class="form form-horizontal" action="<?php echo base_url() ?>password/edit">
    <div class="wrapper">
        <div class="box">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="password" class="form-control input-sm input-size-md" name="old">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">New Password</label>
                            <div class="col-md-9">
                                <input type="password" class="form-control input-sm input-size-md" name="new">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Confirm Password</label>
                            <div class="col-md-9">
                                <input type="password" class="form-control input-sm input-size-md" name="confirm">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="box-footer">
            <button type="button" class="btn btn-info btn-xs send">Save</button>
...
<script>
  ...
  $(document).on("click",".send",function(){
    if($("input[name='confirm']").val()==$("input[name='new']").val()){
      $("form").submit();
    }else{
      $.toast({
          heading: 'Error',
