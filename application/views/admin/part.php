...
<?php $this->load->view('admin/header'); ?>
    ...
    <div class="container-fluid" style="min-height: 76.6vh;">
        <div class="header">
            <h5 style="font-weight: bold;">Part Types</h5>
        </div>
        <div class="body">
            <div class="row">
                <div class="col-md-12">
                    <div class="wrapper">
                        <form action="<?php echo base_url() ?>admin/part_add" method="POST" >
                        ...
                        <tbody>
                            <?php $i=1; foreach ($table as $key => $value) {?>
                                <tr>
                                    ...
                                    <td><center><button class="btn btn-info edit_button" data="<?php echo $value->id; ?>" code="<?php echo $value->code; ?>" name="<?php echo $value->name; ?>" desc="<?php echo $value->desc; ?>"><i class="fa fa-edit"></i> Edit</button><button class="btn btn-danger remove_button" data="<?php echo $value->id; ?>"><i class="fa fa-trash"></i> Delete</button></center></td>
                                </tr>
                            <?php $i+=1; } ?>
                        </tbody>
                    </table>
