        ...
        <div class="box">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h5>Please note only the following column are valid.</h5>
                        <ul>
                            <!--v-for-start--><li>id</li><li>customer_id</li><li>name</li><li>location</li><li>note</li><li>start</li><li>end</li><li>status</li><li>user_id</li><!--v-for-end-->
                        </ul>
                    </div><!--v-if-->
                </div>
            </div>
