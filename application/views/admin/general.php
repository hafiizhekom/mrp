...
<?php $this->load->view('admin/header'); ?>
        ...
        <div class="body">
            <div class="col-md-12">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#company-info" role="tab" data-toggle="tab" aria-expanded="true">Company
                            Info</a></li>
                    <li role="presentation" class=""><a href="#signature" role="tab" data-toggle="tab" aria-expanded="false">Printout &amp; Signatures</a>
                    </li>
                </ul>
                <div class="wrapper">
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="company-info">
            <form method="post" enctype="multipart/form-data" class="form form-horizontal" action="<?php echo base_url() ?>admin/general_edit">
    <div class="box">
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-nd-6">
                            <input type="text" class="form-control" name="name" value="<?php echo $header->name ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Address</label>
                        <div class="col-nd-6">
                            <textarea class="form-control" name="address"><?php echo $header->address ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">City</label>
                        <div class="col-nd-6">
                            <input type="text" class="form-control" name="city" value="<?php echo $header->city ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Phone Number</label>
                        <div class="col-nd-6">
                            <input type="text" class="form-control" name="phone" value="<?php echo $header->phone ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">FAX Number</label>
                        <div class="col-nd-6">
                            <input type="text" class="form-control" name="fax" value="<?php echo $header->fax ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">NPWP</label>
                        <div class="col-nd-6">
                            <input type="text" class="form-control" name="npwp" value="<?php echo $header->npwp ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">SKEP Kawasan Berikat</label>
                        <div class="col-nd-6">
                            <input type="text" class="form-control" name="skep" value="<?php echo $header->skep ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-nd-6">
                            <img class="thumbnail" src="<?php echo base_url()."images/".$header->logo ?>" alt="<?php echo $header->logo ?>">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="box-footer">
        ...
        <div role="tabpanel" class="tab-pane" id="signature">
            <form method="post" enctype="multipart/form-data" class="form form-horizontal" action="<?php echo base_url() ?>admin/general_edit_detail">
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <img class="thumbnail" style="max-width: 100%;" src="<?php echo base_url()."images/".$header->header_image ?>" alt="<?php echo $header->header_image ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="box-body">
            <div class="row">
              <?php foreach ($detail as $key => $value) {?>
                <div class="col-md-6">
                    <h5><b><?php echo strtoupper($value->job); ?></b></h5>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="title[]" value="<?php echo $value->job; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Contact</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="contact[]" value="<?php echo $value->contact; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <img class="thumbnail" style="max-width: 100%;" src="<?php echo base_url() ?>images/<?php echo $value->signature; ?>" alt="<?php echo $value->signature; ?>">
                        </div>
                    </div>
                </div>
              <?php } ?>
