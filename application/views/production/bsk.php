...
<?php $this->load->view('production/header'); ?>
    ...
    <div class="container-fluid" style="min-height: 76.6vh;">
        <div class="header">
            <h5 style="font-weight: bold;">BSK List</h5>
        </div>
        <div class="body">
            <div class="row">
                <div class="col-md-3 col-md-offset-9" style="text-align:right;">
                    <a href="<?php echo base_url() ?>production/bsk/create"><button class="btn btn-success"><i class="fa fa-plus"></i> Add New BSK</button></a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
    ...
    <form action="<?php echo base_url() ?>production/bsk/create" method="POST" id="form_edit">
      <input type="hidden" name="id"  />
    </form>
    <form action="<?php echo base_url() ?>production/bsk/delete" method="POST" id="form_delete">
      <input type="hidden" name="id"  />
    </form>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?php echo base_url() ?>production/bsk/status_update" method="POST">
