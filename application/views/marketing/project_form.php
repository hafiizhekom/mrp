    ...
    <div class="container-fluid" style="min-height: 77.5vh">
        <div class="header">
            <h5 style="font-weight: bold">
                <?php if(empty($project)){ ?>Create New Project<?php }else{?>Edit Project<?php } ?>
            </h5>
        </div>
        <div class="body">
            <div class="col-md-12">
                <form method="post" class="form form-horizontal" action="<?php echo base_url() ?>marketing/project/add">
    <input type="hidden" value="<?php echo $project->id??'';?>" name="id">
    <div class="wrapper">
        <div class="box">
            <div class="box-header">
                <h5 style="font-weight: bold;">Project Information</h5>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" style="text-align: left; font-size: 10pt">Location</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-size-md" name="location" value="<?php echo $project->location??''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3" style="text-align: left; font-size: 10pt">Note</label>
                            <div class="col-md-9">
                                <textarea rows="3" class="form-control input-sm input-size-md" name="note">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-3" style="text-align: left; font-size: 10pt">Start
                                Date</label>
                            <div class="col-md-9">
                                <div class="datepicker">
                                  <input  placeholder="Select Date" type="date" class="form-control input-sm input-size-md" name="start_date" value="<?php echo $project->start_date??''; ?>">
                                </div><!--v-component-->
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3" style="text-align: left; font-size: 10pt">End
                                Date</label>
                            <div class="col-md-9">
                                <div class="datepicker">
                                  <input  placeholder="Select Date" type="date" class="form-control input-sm input-size-md" name="end_date" value="<?php echo $project->end_date??''; ?>">
                                </div><!--v-component-->
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3" style="text-align: left; font-size: 10pt">Already
                                finished</label>
                            <div class="col-md-9">
                                <input type="checkbox" true-value="1" false-value="0" name="is_finished">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="box">
            <div class="box-header">
                <h5 style="font-weight: bold;">Project Contacts</h5>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-9">
    ...
    <div class="table table-bordered table-condensed table-striped datatable" style="display:table;">
        <div class="div-thead">
            <div class="div-tr" slot="head">
                                ...
                                <div class="div-th">Action</div>
                            </div>
        </div>
        <div class="div-tbody">
          <?php if(empty($project_contact)){ ?>
            <!--v-for-start--><div class="div-tr" slot="body">
                                ...
                                <div class="div-td" style="width: 101px">
            ...
            <?php }else{ $i=1; foreach ($project_contact as $key => $value) {?>
          <!--v-for-start--><div class="div-tr" slot="body">
                                <div class="div-td">
