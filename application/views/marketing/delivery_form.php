    ...
    <div class="container-fluid" style="min-height: 76.6vh;">
        <div class="header">
            <h5 style="font-weight: bold;">
              <?php if(empty($table)){ ?>New Delivery Order<?php }else{ echo "Edit Delivery Order"; }?>
            </h5>
        </div>
        <div class="body">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-3" style="color: red;">Packing No</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-size-sm" name="code" value="<?php echo $table->code??''; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3" style="color: red;">No. Jo</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-size-sm" name="code" value="<?php echo $table->code??''; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" style="color: red;">Address</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-size-sm" name="code" value="<?php echo $table->code??''; ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" style="color: red;">No</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-size-sm" name="code" value="<?php echo $table->code??''; ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                            <label class="control-label col-md-3" style="color: red;">No. PO</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-size-sm" name="code" value="<?php echo $table->code??''; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">No. Vehicle</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-size-sm" name="code" value="<?php echo $table->code??''; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea type="text" class="form-control input-sm input-size-sm" name="code" value="<?php echo $table->code??''; ?>">
                                </textarea>
                            </div>
                        </div>
                    </div>
