            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">PIC Cellphone</label>
                            <div class="col-md-8">
                                <textarea disabled="" class="form-control input-size-lg" rows="2" style="height: auto" name="pic_phone"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">PIC Email</label>
                            <div class="col-md-8">
                                <textarea disabled="" class="form-control input-size-lg" rows="2" style="height: auto" name="pic_email"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="col-md-9">
        ...
        <!--<button type="button" @click="generateNumber('Quotation', 'active.no')" class="btn btn-info btn-xs">Generate</button>-->
                        ...
                        <!--<div class="form-group">-->
                            <!--<label class="control-label col-md-3" style="color: red">Qn Number</label>-->
                            <!--<div class="col-md-5">-->
                                <!--<input v-model="active.no" type="text" class="form-control input-sm input-size-md">-->
                                <!--&lt;!&ndash;<button type="button" @click="generateNumber('Quotation', 'active.no')" class="btn btn-info btn-xs">Generate</button>&ndash;&gt;-->
                            <!--</div>-->
                        <!--</div>-->
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">QN Currency</label>
                            <div class="col-md-2">
                            ...
                            <tbody class="div-tbody">
                              <?php if(empty($detail)){?>
                                <tr class="material-0">
                                  ...
                                  <td><textarea class="form-control input-sm" name="detail_desc[]"></textarea></td>
                                  <td><input type="text" class="form-control input-sm" name="detail_qty[]"></td>
                                  <td>
