...
<?php $this->load->view('maintenance/header',$data); ?>
    ...
    <div class="container-fluid" style="min-height: 76.6vh;">
        <div class="header">
            <h5 style="font-weight: bold;">Add New Equipment</h5>
        </div>
        <div class="body">
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" class="form form-horizontal" action="<?php echo base_url() ?>maintenance/equipment/add_single">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-3" style="text-align: left; font-size: 10pt;color: red">
                                Name
                            </label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select type="text" class="form-control input-sm" name="unit">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" style="color: red;">
                                Group
                            </label>
                            <div class="col-md-4">
                                <select type="text" class="form-control input-sm" name="group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" style="text-align: left; font-size: 10pt;color: red">
                                Minimum Stock
                            </label>
                            <div class="col-md-4">
                                <input type="text" class="form-control input-sm" name="minimum_stock">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-condensed table-striped table-hover table-bordered datatable">
                    ...
                    <tbody class="div-tbody">
                      <tr>
                        ...
                        <td><input type="text" class="form-control" name="detail_number[]"></td>
                        <td>
                            <input  placeholder="Select Date" type="date" value="" name="detail_date[]">
                        </td>
                        <td><input type="checkbox" true-value="1" false-value="0" name="detail_status[]">Available</td>
                        <td><input type="text" class="form-control" name="detail_condition[]"></td>
...
<script>
  $(document).on("click",".add_button",function(){
      $(".div-tbody").append('<tr> <td><span class="numbering">1</span></td><td><input type="text" class="form-control" name="detail_number[]"></td><td> <input placeholder="Select Date" type="date" value="" name="detail_date[]"> </td><td><input type="checkbox" true-value="1" false-value="0" name="detail_status[]">Available</td><td><input type="text" class="form-control" name="detail_condition[]"></td><td><input type="text" class="form-control" name="detail_remark[]"></td><td style="width: 57px;"> <button type="button" class="btn btn-info btn-xs add_button"> <i class="fa fa-plus"></i> </button> <button type="button" class="btn btn-danger btn-xs remove_button"> <i class="fa fa-minus"></i> </button> </td></tr>');
