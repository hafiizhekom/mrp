...
<?php $this->load->view('maintenance/header'); ?>
    ...
    <div class="container-fluid" style="min-height: 77.5vh">
        <div class="header">
            <h5 style="font-weight: bold">Equipment Groups</h5>
        </div>
        <div class="body">
            <div class="col-md-4">
                <form method="POST" class="form form-horizontal" action="<?php echo base_url() ?>maintenance/equipment/group_add">
                    ...
                    <tbody>
                        <?php $i=1; foreach ($table as $key => $value) {?>
                            <tr>
                                ...
                                <td><center><button class="btn btn-info edit_button" data="<?php echo $value->id; ?>" code="<?php echo $value->code; ?>" desc="<?php echo $value->desc; ?>" data-name="<?php echo $value->name; ?>"><i class="fa fa-edit"></i> Edit</button><button class="btn btn-danger remove_button" data="<?php echo $value->id; ?>"><i class="fa fa-trash"></i> Delete</button></center></td>
                            </tr>
                        <?php $i+=1; } ?>
                    </tbody>
                </table>
