...
<?php $this->load->view('purchasing/header'); ?>
    ...
    <div class="container-fluid" style="min-height: 77.5vh">
        ...
        <div class="body">
            <div class="col-md-12">
                <form class="form form-horizontal" method="POST" action="<?php echo base_url() ?>purchasing/vendor/add">
    <input type="hidden" name="id" value="">
    <div class="wrapper">
        <div class="box">
            <div class="box-header">
                <h5 style="font-weight: bold">Vendor Information</h5>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label col-md-3">PPN/VAT</label>
                            <input type="radio" value="1" name="ppn">
                            <label>PPN</label>
                            <input type="radio" value="0" name="ppn">
                            <label>Non PPN</label>
                            <br>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Vendor Outsource</label>
                            <input type="radio" value="1" name="outsource">
                            <label>Yes</label>
                            <input type="radio" value="0" name="outsource">
                            <label>No</label>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Vendor Code</label>
                            <div class="col-md-6">
                                <input type="text" name="code" class="form-control input-sm" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Supplier Name</label>
                            <div class="col-md-6">
                                <input type="text" name="supplier_name" class="form-control input-sm" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Address</label>
                            <div class="col-md-6">
                                <textarea name="address" cols="3" class="form-control input-sm"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="post" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select type="text" name="currency" class="form-control input-sm">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Attn.</label>
                            <div class="col-md-6">
                                <input type="text" name="attn" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="tkip" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Delivery Terms (In Days)</label>
                            <div class="col-md-6">
                                <input type="text" name="delivery" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Payment Terms(In Days)</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="note" id="" cols="3" class="form-control input-sm"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped datatable table-bordered">
                            ...
                            <tbody class="div-tbody">
                              <tr>
                                <td class="numbering">1<input type="hidden" name="contact_id[]" value=""></td>
                                <td><input type="text" class="form-control input-sm" name="contact_name[]"></td>
                                <td><input type="text" class="form-control input-sm" name="contact_phone[]"></td>
                                <td><input type="text" class="form-control input-sm" name="contact_handphone[]"></td>
                                <td><input type="text" class="form-control input-sm" name="contact_email[]"></td>
                                <td><input type="text" class="form-control input-sm" name="contact_position[]"></td>
                                <td>
                                    <button type="button" class="btn btn-primary btn-xs add_button"><i class="fa fa-plus"></i>
                                    </button>
                                    <button type="button" class="btn btn-danger btn-xs remove_button"><i class="fa fa-minus"></i></button>
                                </td>
                              </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript">
  $(document).on("click",".add_button",function(){
      $(".div-tbody").append('<tr> <td class="numbering">1<input type="hidden" name="contact_id[]" value=""></td><td><input type="text" class="form-control input-sm" name="contact_name[]"></td><td><input type="text" class="form-control input-sm" name="contact_phone[]"></td><td><input type="text" class="form-control input-sm" name="contact_handphone[]"></td><td><input type="text" class="form-control input-sm" name="contact_email[]"></td><td><input type="text" class="form-control input-sm" name="contact_position[]"></td><td> <button type="button" class="btn btn-primary btn-xs add_button"><i class="fa fa-plus"></i> </button> <button type="button" class="btn btn-danger btn-xs remove_button"><i class="fa fa-minus"></i></button> </td></tr>');
