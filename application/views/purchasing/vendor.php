...
<?php $this->load->view('purchasing/header'); ?>
    ...
    <div class="container-fluid" style="min-height: 77.5vh">
        <div class="header">
            <h5 style="font-weight: bold">Vendor List</h5>
        </div>
        <div class="body">
            <div class="col-md-3 col-md-offset-9" style="text-align:right;">
                <a href="<?php echo base_url() ?>purchasing/vendor/create"><button class="btn btn-success"><i class="fa fa-plus"></i> Add New Vendor</button></a>
            </div>
            <div class="col-md-12">
                    ...
                    <tbody>
                        <?php $i=1; foreach ($table as $key => $value) {?>
                           <tr>
                               ...
                               <td><?php echo $value->outsource; ?></td>
                               <td><?php if($value->ppn==1){echo "PPN";}else{echo "NON-PPN";} ?></td>
                               <td><?php echo $value->phone; ?></td>
                               <td><?php echo $value->fax; ?></td>
                               <td><?php echo $value->attn ?></td>
                               <td><ul><?php foreach ($contact as $key2 => $value2) {
                                   if($value->id==$value2->vendor_id){
