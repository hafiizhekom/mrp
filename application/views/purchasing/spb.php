...
<form id="edit_form" action="<?php echo base_url() ?>purchasing/material/create" method="POST">
    <input type="hidden" id="edit" name="id" />
</form>

<form id="delete_form" action="<?php echo base_url() ?>purchasing/material/delete" method="POST">
